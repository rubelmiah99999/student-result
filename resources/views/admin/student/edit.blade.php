                        ...
                        <form action="{{ route('students.update', $student->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter name" required value="{{ $student->name }}">
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <select class="custom-select" name="subject[]" required>
                                                    ...
                                                    <option value="{{$subject->id}}" {{ $studentResult->subject_id ==  $subject->id ? 'selected' : '' }}>{{ Str::ucfirst($subject->subject_name) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <input type="hidden" name="result_id[]" value="{{ $studentResult->id }}">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" class="form-control" id="achieve_number"name="achieve_number[]" required placeholder="Enter number" value="{{$studentResult->achieve_number}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
